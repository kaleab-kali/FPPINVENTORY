...
const checkPersonnelRole = async (req: Request, res: Response, next: NextFunction): Promise<Response<any, Record<string, any>> | void> => {
...
export default checkPersonnelRole;
